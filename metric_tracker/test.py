...
if __name__ ==  "__main__":
    ...
    for thr in [0.5,0.55,0.6,0.65,0.7,0.75,0.8]:
        ...
        for i in range(1,46):
            ...
            main('D:\Program Files\Anti-UAV-master\Codes\metric_uav\metric_tracker\pytracking/video_{}_0.txt'.format(i),
                    'D:\Program Files\Anti-UAV-master\Codes\metric_uav\metric_tracker\crop_gt/new_video_{}_0.txt'.format(i), i,thr)
